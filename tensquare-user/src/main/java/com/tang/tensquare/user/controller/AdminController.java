...
import com.tang.tensquare.user.service.AdminService;
...
public class AdminController {
	...
	public Result login(@RequestBody Map<String, String> loginMap) {
		Admin admin = adminService.login(loginMap.get("loginname"), loginMap.get("password"));
		String token = jwtUtil.createJWT(admin.getId(), admin.getLoginname(), "admin");
		System.out.println(jwtUtil.getKey());
		System.out.println(jwtUtil.getTtl());
		Map<String, String> map = new HashMap<>();
		map.put("token", token);
		map.put("user", admin.getLoginname());
