package com.tang.tensquare.article.controller;
...
import com.tang.tensquare.article.service.ArticleService;
...
public class ArticleController {
	...
	public Result auditArticle(@PathVariable String articleId) {
	...
	public Result thumbupArticle(@PathVariable String articleId) {
		articleService.thumbupArticle(articleId);
		return new Result(true,StatusCode.OK,"success",null);
	}
