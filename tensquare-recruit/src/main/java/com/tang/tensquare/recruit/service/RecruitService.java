package com.tang.tensquare.recruit.service;
...
import com.tang.tensquare.recruit.dao.RecruitDao;
...
public class RecruitService {
	...
	public List<Recruit> recommendJobList() {
		return recruitDao.findTop3ByState("2");
	}


	public List<Recruit> newJobList() {
		return recruitDao.findTop3ByStateNotOrderByCreatetimeDesc("0");
	}
	
	public List<Recruit> newJobList2() {
